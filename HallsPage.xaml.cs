...
namespace CinemaBox_for_WinRT
{
    ...
    /// </summary>
    public sealed partial class HallsPage : Page
    {
        ...
        private async void ViewInfoInWeb_Click(object sender, RoutedEventArgs e)
        {
            await Windows.System.Launcher.LaunchUriAsync(new Uri("http://www.parkcinema.az/melumat?lang=ru"));
        }

        private void About_HallsPage_Click(object sender, RoutedEventArgs e)
        {
